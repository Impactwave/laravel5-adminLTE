...
return [
	...
	*/
	...
	"required_if"          => "Por favor preencha o campo :attribute quando o valor do campo :other é igual a :value.",
	"required_with"        => "Por favor preencha o campo :attribute quando :values está presente.",
	"required_with_all"    => "The :attribute field is required when :values is present.",
	"required_without"     => "Por favor preencha o campo :attribute quanto :values não está presente.",
	"required_without_all" => "Por favor preencha o campo :attribute quando nenhum dos :values está presente.",
