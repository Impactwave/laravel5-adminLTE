...
return [
	...
	*/
      ...
      'EMAIL'           => 'E-mail',
      'PASSWORD'        => 'Senha',
      'VERIFY PASSWORD' => 'Verificação da Senha',
      'REMEMBER ME'     => 'Memorizar-me',
      'LOGIN'           => 'Iniciar sessão',
      'LOGOUT'          => 'Terminar sessão',
      'CHANGE PASSWORD' => 'Alterar senha',
      'REGISTER'        => 'Registar-se',
      'REGISTER 2'      => 'Ainda não está registado?',
      'REGISTRATION'    => 'Registo de utilizador',
      'REGISTER 1'      => 'Eu já estou resgistado',
      'PASS PROMPT'     => 'mínimo de 8 caracteres',
      'PASS2 PROMPT'    => 'repita a senha acima',
      'FORGOT'          => 'Esqueceu a senha?',
      'RESET PASSWORD'  => 'Repor senha',
      'RESET TEXT'      => 'Para definir uma nova senha de acesso, indique o mesmo endereço de email que usou anteriormente para se registar.',
      'AGREE'           => 'Concordo com os',
      'AGREE 1'         => 'termos',
      'PROBLEMS'        => 'Existem alguns problemas com os seus dados.',
      'PROBLEMS 1'      => 'Atenção!',
